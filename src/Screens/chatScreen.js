...
import { View, Text, StyleSheet, Modal, Alert, Pressable, TouchableHighlight, TouchableOpacity } from "react-native";
...
const ChatDisplay = ({ route, navigation }) => {
    ...
    const getChatId = async () => {
        const chatQuery = query(chatsRef, where("participants", "array-contains", userId));
    ...
    useEffect(() => {
        ...
        const unsubscribe = onSnapshot(messagesDocRef, async (docSnap) => {
            ...
            if ((messageCount % 50) == 0 && !docSnap.data().ascended && messageCount != 0) {
            ...
            >
                ...
                <View style={styles.centeredView}>
                    <View style={styles.modalView}>
                        <Text style={styles.modalText}>Congratulations! This chat can be ascended, would you like to ascend?</Text>
