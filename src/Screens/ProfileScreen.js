...
const ProfileScreen = ({ navigation }) => {
  ...
  useEffect(() => {
    ...
    const unsubscribe = onSnapshot(userDocRef,
        ...
        (error) => {
          ...
          Alert.alert('Error', 'Failed to fetch real-time updates from Firestore.');
        }
      );
  ...
  const { name, dateOfBirth, gender, photos = [], favGenres, favAuthors } = userData;
    ...
    <View style={styles.container}>
      <View style={styles.profileHeader}>
        ...
        <View style={styles.profileDetails}>
          ...
          <Text style={styles.ageText}>Age: {calculateAge(Myuser.dateOfBirth)}</Text>
          <Text style={styles.genderText}>Gender: {Myuser.gender || 'N/A'}</Text>
        </View>
      </View>
      ...
      >
        <View style={styles.modalOverlay}>
          <View style={styles.modalContent}>
            <Text style={styles.modalHeaderText}>Are you sure you want to delete your profile?</Text>
            ...
            <View style={styles.modalButtons}>
              <TouchableOpacity style={styles.closeModalButton} onPress={() => setDeleteModalVisible(false)}>
                <Text style={styles.closeModalText}>Cancel</Text>
              </TouchableOpacity>
              <TouchableOpacity style={[styles.closeModalButton, styles.deleteModalButton]} onPress={handleDeleteProfile}>
